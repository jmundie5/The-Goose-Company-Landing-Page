  ...
  return (
    ...
    >
          ...
          <div class="row mt-3">
            <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
              <h6 class="text-uppercase fw-bold mb-4">
                <i class="fas fa-gem me-3 text-secondary"></i>the Goose company.
              </h6>
              <p>
      ...
      <div
        ...
        styles="background-color: rgba(0, 0, 0, 0.025);"
      >
        © 2023 Copyright
        <a class="text-reset fw-bold" href="https://justinmundie.com/">
          <br />
          Justin Mundie
        </a>
      </div>
